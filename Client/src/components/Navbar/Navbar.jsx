              ...
              {userInfo ? (
                <div className="flex items-center gap-x-2">
                  <Link
                    to={"/addCourse"}
                    type="button"
                    className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-md text-sm md:px-5 md:py-2.5 px-1 py-1 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  >
                    Add Course
                  </Link>
