      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        ...
        >
          ...
          <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">
            ...
            implementation, and optimization.Previews are also avialable
          </p>
          <a
            href="#"
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">
              The live and recorded video lectures with the best quality are
              available 24x7
            </p>
            <a
              href="#"
          ...
          >
            ...
            <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">
              Level up in life and your career with the guidance of the best
              mentors and experts around.
            </p>
            <a
              href="#"
              className="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center"
          ...
          >
            ...
            <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">
              Learn things by building awesome projects and doing open source
              contributions
            </p>
            <a
              href="#"
